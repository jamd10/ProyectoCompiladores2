...
public class MiniCLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"DO", "RETURN", "TRUE", "FALSE", "AND", "OR", "EQ", "NEQ", "LE", "GE", 
			"LT", "GT", "ASSIGN", "PLUS", "MINUS", "STAR", "DIV", "MOD", "NOT", "AMP", 
			"SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "LBRACK", "RBRACK", 
			"Identifier", "IntegerConst", "InvalidCharLiteral", "CharConst", "UnclosedChar", 
			"StringLiteral", "UnclosedString", "EscapeSequence", "WS", "LINE_COMMENT", 
